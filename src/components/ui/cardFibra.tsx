        ...
        {teste.map((teste1)=>(
          ...
          key={teste1.megas}>
            <div className='flex flex-col h-72 justify-between items-center border border-black gap-6 rounded-md w-full p-5'>
              ...
              <a target='_blank' href={`https://wa.me/5522997242334?text=Ol%C3%A1,%20quero%20ser%20um%20cliente%20da%20SmartLagos%20e%20me%20interessei%20pelo%20${teste1.plano}%20de%20${teste1.megas}%20${cn(teste1.bytes === 'Megas' ? 'megas' : 'giga')}`} className='focus:bg-fuchsia-600 hover:bg-fuchsia-600 transition-all bg-fuchsia-700 w-full flex justify-center items-center rounded active:bg-fuchsia-900' >
