        ...
        {teste.map((teste1)=>(
          ...
          key={teste1.megas}>
            <div className='flex flex-col h-72 justify-between items-center gap-6 rounded-xl w-full p-5 px-6 py-3 tracking-wider bg-branco shadow-[4px_4px_8px_#d1d1d1,-4px_-4px_8px_#ffffff]'>
              ...
              <p className='flex text-lg justify-center items-center w-full py-1 px-6 rounded-full bg-branco font-normal text-rosa  shadow-[inset_4px_4px_8px_#d1d1d1,inset_-4px_-4px_8px_#ffffff]'>R$ {teste1.preco}/Mês</p>
